...
print('========== From Scratch: ResNet152 ==========')

model_pt = models.resnet152(pretrained=True)
model_pt.fc = nn.Linear(2048, NUM_CLASSES)
model_pt_weight = model_pt.state_dict()

# model, criterion, optimizer
model_resnet = ResNet152(input_size=32, num_output=NUM_CLASSES)
model_resnet.load_state_dict(model_pt_weight, strict=False)
