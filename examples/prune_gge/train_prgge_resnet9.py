...
from shelf.trainers.zeroth_order import gradient_fo, gradient_fwd
...
print(f"Pruing Rate: {PRUNING_RATE:.2f} | Subdim Rate: {SUBDIM_RATE:.2f}")
# Train the model
for epoch in range(EPOCHS):
    ...
    for i, (input, label) in pbar:
        ...
        estimated_gradient = gradient_fwd(input, label, model, functional_xent, query=int(num_param * (1 - PRUNING_RATE)))
