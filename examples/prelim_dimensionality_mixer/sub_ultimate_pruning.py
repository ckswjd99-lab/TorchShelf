...
model_paths = ['./saves/set1_default/initial_weights.pth'] + [f'./saves/set1_default/epoch_{i * int(100/NUM_GROUPS)}.pth' for i in range(1, NUM_GROUPS + 1)] + ['./saves/set1_default/final_weights_vloss.0.788.pth']
